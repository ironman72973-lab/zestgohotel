...
/* =========================================================
   MAIN COMPONENT
========================================================= */
export default function AirportDrop() {
    /* =====================================================
       CURRENT DATE
    ===================================================== */
    const today =
    ...
    /* =====================================================
       HOTEL → AIRPORT ROUTING
    ===================================================== */
    const [
        hotelAirportDistance,
        setHotelAirportDistance
    ] = useState("");
    const [
        hotelAirportDuration,
        setHotelAirportDuration
    ] = useState("");
    const [
        routeLoading,
        setRouteLoading
    ...
    const getFlightDetails =
        async () => {
            ...
            try {
                ...
                ================================================= */
                const airportLat =
                    data.departure?.location?.latitude;
                const airportLng =
                    data.departure?.location?.longitude;
                setDepartureLatitude(
                    airportLat ?? ""
                );
                setDepartureLongitude(
                ...
                const departureLocal =
                    data.departure?.scheduled?.local ||
    ...
    /* =====================================================
       ...
       PROJECT OSRM
    ===================================================== */
    const calculateHotelToAirportRoute =
        async (
            pickupLat,
            pickupLng,
            airportLat,
            ...
            try {
                 ...
                 */
                const coordinates =
                    `${pickupLng},${pickupLat};${airportLng},${airportLat}`;
                const url =
                ...
                /*
                 * Keep numeric distance.
                 *
                 * DO NOT store "18.4 km"
                 *
                 * because fare calculation needs a number.
                 */
                setHotelAirportDistance(
                    distanceKm
                );
                ...
                <section className="booking-card">
                    ...
                    <div className="booking-content">
                        ...
                        <div className="panel">
                            ...
                            <div className="pickup-grid">
                                ...
                                <div className="pickup-location-field">
                                    <label className="field">
                                        ...
                                        <div className="field-box pickup-location-box">
                                            <span className="field-icon">
                                                <Icon
                                                    name="pin"
                                                    size={19}
                                            ...
                                            <input
                                                ...
                                                placeholder="Enter hotel / pickup location"
                                            />
                                        </div>
                                    </label>
                                    <button
                            ...
                            {/* HIDDEN HOTEL → AIRPORT DISTANCE */}
                            <span
                                className="hotel-airport-distance"
                                data-distance-km={
                                    hotelAirportDistance
                                }
                            ...
                            <span
                                className="departure-airport-coordinates"
                                data-latitude={
                                    departureLatitude
                                }
                                data-longitude={
                    ...
                    <div className="summary-body">
                        ...
                        {routeLoading && (
                            <div className="route-calculating">
                                Calculating hotel → airport route...
                            </div>
                        )}
                        {/* =================================================
                           FARE
                        ...
                        <div className="fare-box">
                            ...
                            <FareRow
                                label={
                                    `Distance Fare (${distanceDisplay} km × ₹${RATE_PER_KM.toFixed(
                                        2
                                    )})`
                                }
                                value={
