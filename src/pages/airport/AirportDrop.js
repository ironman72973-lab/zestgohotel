...
export default function App() {
  ...
  const [instructions, setInstructions] =
    useState("");
  const [acVehicle, setAcVehicle] =
    useState(true);
  const [babySeat, setBabySeat] =
    useState(false);
  const [extraLuggage, setExtraLuggage] =
    useState(false);
  const [femaleDriver, setFemaleDriver] =
    useState(false);
  /* =======================================================
     FARE
  ======================================================= */
          ...
          <div className="booking-content">
            ...
            <div className="service-heading">
              ...
              <div>
                ...
                <p>
                  Pick up your guest from the hotel
                  and drop them at the airport.
                </p>
              </div>
            </div>
            {/* =================================================
            ...
            <div className="panel">
              ...
              {/* SECOND ROW */}
              <div className="pickup-second-row">
                <Field
                  label="Pickup Time"
                  required
                  icon="clock"
